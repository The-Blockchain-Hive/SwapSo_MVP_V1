...
import { CourseCurriculumType } from "../constants/Types";

// Use the aboutCourseData variable as the source of data
const CourseCurriculum = (props: CourseCurriculumType) => {
  ...
  let aboutCourseData = {
    course: {
      ...
      about:
        "In this comprehensive course, you'll learn the ins and outs of React and how to build modern web applications.",
  ...
  return (
    <div className="bg-white text-black mx-auto text-center p-8">
      <div>
        <h2 className="text-center text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-900 to-blue-700 mb-10">
          Curriculum
        </h2>
        {aboutCourseData.course.curriculum.map(
                ...
                <div>
                  {section.section.subsections.map((subsection, subIndex) => (
                    <div key={subIndex} className="ml-4">
                      <h5
                        onClick={() =>
                          toggleSection(`${sectionIndex}.${subIndex}`)
                        }
