...
import { MentorSectionType } from "../constants/Types";

export default function MentorSection(props: MentorSectionType) {
  ...
  return (
    <section className="bg-white text-black p-8">
      <h2 className="text-5xl font-bold mb-4 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-900 to-blue-700">
        Meet Your Mentor
      </h2>
      <div className="flex items-center justify-center mt-16">
        ...
        <div className="w-1/2 mr-96">
          ...
          <a
            href={coursesData[0]?.EducatorSocials}
            target="_blank"
