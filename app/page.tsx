...
export default function Home() {
  ...
  return (
    <main className="gradient-bg">
      ...
      <div className="flex flex-row flex-wrap xl:flex-nowrap lg:flex-nowrap xl:space-x-8 m-12 lg:m-8 md:m-8 lg:m-12 xl:m-16">
