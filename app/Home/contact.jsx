...
const ContactForm = () => {
  ...
  const sendEmail = async (e) => {
    ...
    try {
      await emailjs.sendForm(service_id,
      template_id,
      formRef.current,
      user_id);
    ...
    <div className="contact-info-card">
      ...
      <div className="contact-form">
        <form ref={formRef} onSubmit={sendEmail}>
          ...
          <div className="form-row">
    <button type="submit" className="send-button" style={{ color:  'aqua', backgroundColor: 'black', border: '2px solid black', marginBottom: '10px' }}>
